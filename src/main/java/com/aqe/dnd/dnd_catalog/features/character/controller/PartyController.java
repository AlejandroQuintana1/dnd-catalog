...
public class PartyController {
    ...
    @GetMapping
    public List<PartyEntity> getMethodName() {
    ...
    @GetMapping("/{id}")
    public PartyEntity getPartyById(@PathVariable UUID id) {
    ...
    @PutMapping("/{id}")
    public PartyEntity updateParty(@PathVariable UUID id, @RequestBody PartyEntity party){
